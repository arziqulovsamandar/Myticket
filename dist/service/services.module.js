...
exports.ServicesModule = ServicesModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([service_model_1.Service])],
        controllers: [services_controller_1.ServicesController],
        providers: [services_service_1.Service_Services],
        exports: [services_service_1.Service_Services],
    })
], ServicesModule);
